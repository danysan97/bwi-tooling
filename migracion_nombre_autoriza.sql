ALTER TABLE ordenes_trabajo ADD COLUMN IF NOT EXISTS nombre_autoriza TEXT;
ALTER TABLE ordenes_trabajo ADD COLUMN IF NOT EXISTS puesto_autoriza TEXT;

DROP VIEW IF EXISTS public.vista_ordenes;

CREATE VIEW public.vista_ordenes AS
SELECT
  o.no_orden,
  o.fecha_solicitud,
  o.nombre_pieza,
