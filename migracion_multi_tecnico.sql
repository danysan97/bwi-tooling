-- ============================================================
-- MIGRACIÓN: Soporte para múltiples técnicos por orden
...
-- 2. Recrear la vista con subqueries para múltiples técnicos
...
-- Listo. La vista ahora agrega datos de múltiples técnicos por orden.
