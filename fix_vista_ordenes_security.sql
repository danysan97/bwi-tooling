...
ALTER VIEW vista_ordenes OWNER TO authenticated;

GRANT SELECT ON vista_ordenes TO anon;
GRANT SELECT ON vista_ordenes TO authenticated;
GRANT SELECT ON vista_ordenes TO service_role;
